...
func (me * THSarabunBold)GetType() string{
	return me.fonttype
}
func (me * THSarabunBold)GetName() string{
	return me.name
}	
func (me * THSarabunBold)GetDesc() []FontDescItem{
	return me.desc
}
func (me * THSarabunBold)GetUp() int{
	return me.up
}
func (me * THSarabunBold)GetUt()  int{
	return me.ut
}
func (me * THSarabunBold)GetCw() FontCw{
	return me.cw
}
func (me * THSarabunBold)GetEnc() string{
	return me.enc
}
func (me * THSarabunBold)GetDiff() string {
	return me.diff
}
func (me * THSarabunBold) GetOriginalsize() int{
	return 98764
}
func (me * THSarabunBold)  SetFamily(family string){
	me.family = family
}
func (me * THSarabunBold) 	GetFamily() string{
	return me.family
}
